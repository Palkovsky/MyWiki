...
public class NewestArticlesFragment extends Fragment implements OnItemClickListener, View.OnClickListener, BGARefreshLayout.BGARefreshLayoutDelegate {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mRecyclerView = (RecyclerView) v.findViewById(R.id.newestArticles_recyclerView);
        noInternetLayout = (LinearLayout) v.findViewById(R.id.newest_no_internet_layout);
        mErrorMsg = (TextView) v.findViewById(R.id.newest_error_msg);
